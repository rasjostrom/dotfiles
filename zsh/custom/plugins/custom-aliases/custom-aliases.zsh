...
## Utils
#Pastebin
alias -g pasta="| curl -F c=@- https://ptpb.pw | sed -e 's/url: //' -n -e '/https/p' | xclip -selection c && echo 'YOUR PASTA IS READY'"
...
alias runclient='python2 -m SimpleHTTPServer 8080'
